...
$mysql_installation_array[PVDatabase::getApplicationsTableName()]="CREATE TABLE ".PVDatabase::getApplicationsTableName()." (
    ...
    admin_directory VARCHAR(255) NOT NULL DEFAULT '',
    ...
    admin_mootools_libraries text NOT NULL DEFAULT '',
    ...
    mootools_libraries text NOT NULL DEFAULT '',
...
$postgresql_installation_array[PVDatabase::getApplicationsTableName()]="CREATE TABLE ".PVDatabase::getApplicationsTableName()." (
    ...
    admin_directory character varying(255) NOT NULL DEFAULT ''::character varying,
    ...
    admin_mootools_libraries text NOT NULL DEFAULT ''::text,
    ...
    mootools_libraries text NOT NULL DEFAULT ''::text,
...
$mssql_installation_array[PVDatabase::getApplicationsTableName()]="CREATE TABLE ".PVDatabase::getApplicationsTableName()." (
	...
	admin_directory varchar(255) DEFAULT '' NOT NULL,
	...
	admin_mootools_libraries varchar(max) DEFAULT '' NOT NULL,
	...
	mootools_libraries varchar(max) DEFAULT '' NOT NULL,
...
$mysql_installation_array[PVDatabase::getMenuItemsTableName()]="CREATE TABLE ".PVDatabase::getMenuItemsTableName()." (
    menu_id INT NOT NULL DEFAULT 0 NOT NULL,
