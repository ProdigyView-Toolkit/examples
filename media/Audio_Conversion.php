...
Audio::convertAudioFile($audio_file, PV_ROOT.PV_AUDIO.'sampe_audio_1.wav');
...
Audio::convertAudioFile($audio_file, PV_ROOT.PV_AUDIO.'sampe_audio_2.mp3', $options);

$options = array(
	'output_acodec' => 'libvorbis'
);
//Convert to sample_audio using a code
Audio::convertAudioFile($audio_file, PV_ROOT.PV_AUDIO.'sampe_audio_2.ogg', $options);

$options = array(
	'output_ab' => '160k'
);
//Lower the bit rate to 160k
Audio::convertAudioFile($audio_file, PV_ROOT.PV_AUDIO.'compressed_1.mp3', $options);
...
Audio::convertAudioFile($audio_file, PV_ROOT.PV_AUDIO.'compressed_2.mp3', $options);
...
Audio::convertAudioFile($audio_file, PV_ROOT.PV_AUDIO.'compressed_3.mp3', $options);
