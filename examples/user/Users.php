...
<html>
	...
	<body>
		...
		<p>
			Created a user with the following parameters:			<pre><?php print_r($args);?></pre>
</p>		<p>
			ID of user:<?php echo $user_id_1;?>
		</p>
		<?php
		...
		<p>
			...
			ID of user:<?php echo $user_id_2;?>
		</p>
		<?php $user_info = PVUsers::getUserInfo($user_id_1);?>
		<p>
			User Info retrieved by ID: 			<pre><?php print_r($user_info);?></pre
</p>		<?php $user_info = PVUsers::getUserInfo('gadgetman@example.com');?>
		<p>
			User Info retrieved by Email: 			<pre><?php print_r($user_info);?></pre>
</p>		<br />
		<br />
		<?php
...
foreach($user_list as $user){
		?>
		<p>
			Deleting user <?php echo $user['username'];?>
		</p>
		<?php
